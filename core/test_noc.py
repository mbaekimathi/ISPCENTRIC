...
class NocBoardTests(TestCase):
    ...
    def test_noc_page_and_summary_require_owner_workspace(self):
        ...
        self.assertContains(page, "NOC")
        self.assertContains(page, 'data-noc-view="ops"')
        self.assertNotContains(page, "noc-mode-tabs")
        self.assertContains(page, "Alarms")
        self.assertContains(page, "noc-kpi-strip")
        self.assertContains(page, "noc-stage")
        self.assertContains(page, 'data-noc-panel="visual"')
        self.assertContains(page, 'data-noc-panel="data"')
        ...
        self.assertNotContains(page, "noc-display-toggle")
        ...
        self.assertContains(down, "Clients affected")
