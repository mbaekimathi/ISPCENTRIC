...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0047_communication_settings"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="PlatformCommunicationSettings",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=120,
                        verbose_name="SMS username / Account SID",
                    ),
                ),
                (
                    "sms_api_key",
                    models.CharField(
                        ...
                        max_length=512,
                        verbose_name="SMS API key / Auth token",
                    ),
                ),
                (
                    "sms_sender_id",
                ...
                (
                    ...
                    models.URLField(
                        ...
                        max_length=500,
                        verbose_name="Custom SMS API URL",
                    ),
                ),
                (
                    "email_enabled",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=120,
                        verbose_name="WhatsApp username / Account SID",
                    ),
                ),
                (
                    "whatsapp_api_key",
                    models.CharField(
                        ...
                        max_length=512,
                        verbose_name="WhatsApp API key / Auth token",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=30,
                        verbose_name="WhatsApp from number",
                    ),
                ),
